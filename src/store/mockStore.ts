...
const USERS = [
  { id: 1, full_name: 'Phúc Trọng (Admin)', email: 'admin@minth.io', role: 'admin' },
  { id: 2, full_name: 'Thế Anh (Sales)', email: 'sale@minth.io', role: 'sale' },
  { id: 3, full_name: 'Minh Khôi (Manager)', email: 'manager@minth.io', role: 'manager' },
];

const COMPANIES = [
  { id: 1, name: 'Tập đoàn Công nghệ FPT', industry: 'Công nghệ & Viễn thông', address: 'Duy Tân, Cầu Giấy, Hà Nội', website: 'https://fpt.com.vn', tax_id: '0101248141', size: '500+', stage_id: 5, expected_revenue: 5000000000, status: 'active', legal_representative: 'Trương Gia Bình' },
  { id: 2, name: 'Vingroup JSC', industry: 'Đa ngành', address: 'Vinhomes Riverside, Long Biên, Hà Nội', website: 'https://vingroup.net', tax_id: '0100526974', size: '500+', stage_id: 1, expected_revenue: 12000000000, status: 'active', legal_representative: 'Phạm Nhật Vượng' },
  { id: 3, name: 'Ngân hàng TMCP Vietcombank', industry: 'Tài chính - Ngân hàng', address: '198 Trần Quang Khải, Hà Nội', website: 'https://vietcombank.com.vn', tax_id: '0100112437', size: '500+', stage_id: 4, expected_revenue: 850000000, status: 'active' },
  { id: 4, name: 'Công ty CP Sữa Việt Nam (Vinamilk)', industry: 'F&B', address: '10 Tân Trào, Quận 7, TP.HCM', website: 'https://vinamilk.com.vn', tax_id: '0300588569', size: '500+', stage_id: 5, expected_revenue: 3200000000, status: 'active' },
  { id: 5, name: 'Giao Hàng Tiết Kiệm (GHTK)', industry: 'Logistics', address: 'Phạm Hùng, Từ Liêm, Hà Nội', website: 'https://ghtk.vn', tax_id: '0106181234', size: '500+', stage_id: 2, expected_revenue: 1500000000, status: 'prospect' },
  { id: 6, name: 'Công ty CP Thế Giới Di Động', industry: 'Bán lẻ', address: 'Quận 9, TP.HCM', website: 'https://mwg.vn', tax_id: '0303217354', size: '500+', stage_id: 3, expected_revenue: 4500000000, status: 'active' },
  { id: 7, name: 'Shopee Việt Nam', industry: 'E-commerce', address: 'Quận 1, TP.HCM', website: 'https://shopee.vn', tax_id: '0106774844', size: '500+', stage_id: 4, expected_revenue: 2800000000, status: 'active' },
  { id: 8, name: 'VNG Corporation', industry: 'Công nghệ / Games', address: 'Quận 7, TP.HCM', website: 'https://vng.com.vn', tax_id: '0303543740', size: '500+', stage_id: 5, expected_revenue: 1800000000, status: 'active' },
  { id: 9, name: 'Công ty CP Hàng không Vietjet', industry: 'Hàng không', address: 'Quận Tân Bình, TP.HCM', website: 'https://vietjetair.com', tax_id: '0102325399', size: '500+', stage_id: 2, expected_revenue: 6500000000, status: 'active' },
  { id: 10, name: 'Grab Việt Nam', industry: 'Technology Service', address: 'Quận 7, TP.HCM', website: 'https://grab.com/vn', tax_id: '0312650437', size: '500+', stage_id: 3, expected_revenue: 950000000, status: 'prospect' },
];

const CONTACTS = [
  { id: 1, first_name: 'Nguyễn', last_name: 'Quang Anh', email: 'anh.nq@fpt.com.vn', phone: '0901234567', company_id: 1, company_name: 'FPT Corp', job_title: 'Giám đốc Công nghệ (CTO)', status: 'customer', source: 'referral', last_contact: '2026-05-06', owner_id: 2, stage_id: 5, expected_revenue: 2500000000, tags: ['Khách VIP', 'Tech Giant'] },
  { id: 2, first_name: 'Trần', last_name: 'Thanh Hà', email: 'ha.tt@vingroup.net', phone: '0987654321', company_id: 2, company_name: 'Vingroup', job_title: 'Trưởng phòng Mua sắm', status: 'qualified', source: 'website', last_contact: '2026-05-01', owner_id: 1, stage_id: 1, expected_revenue: 8500000000, tags: ['BĐS', 'Potential'] },
  { id: 3, first_name: 'Lê', last_name: 'Hoàng Nam', email: 'nam.lh@vietcombank.com.vn', phone: '0912123123', company_id: 3, company_name: 'Vietcombank', job_title: 'Phó TGĐ Tài chính', status: 'lead', source: 'cold_call', last_contact: '2026-04-20', owner_id: 3, stage_id: 4, expected_revenue: 450000000 },
  { id: 4, first_name: 'Phạm', last_name: 'Thị Tuyết', email: 'tuyet.pt@vinamilk.com.vn', phone: '0933445566', company_id: 4, company_name: 'Vinamilk', job_title: 'Quản lý Chuỗi cung ứng', status: 'customer', source: 'social', last_contact: '2026-05-05', owner_id: 2, stage_id: 5, expected_revenue: 1200000000 },
  { id: 5, first_name: 'Hoàng', last_name: 'Minh Đức', email: 'duc.hm@ghtk.vn', phone: '0966778899', company_id: 5, company_name: 'GHTK', job_title: 'Head of Operations', status: 'qualified', source: 'event', last_contact: '2026-04-30', owner_id: 1, stage_id: 2, expected_revenue: 3000000000 },
  { id: 6, first_name: 'Đặng', last_name: 'Hải Yến', email: 'yen.dh@mwg.vn', phone: '0944556677', company_id: 6, company_name: 'Thế Giới Di Động', job_title: 'Giám đốc Nhân sự', status: 'customer', source: 'other', last_contact: '2026-05-02', owner_id: 2, stage_id: 3, expected_revenue: 1500000000 },
  { id: 7, first_name: 'Vũ', last_name: 'Duy Mạnh', email: 'manh.vd@shopee.vn', phone: '0909090909', company_id: 7, company_name: 'Shopee', job_title: 'E-commerce Director', status: 'qualified', source: 'referral', last_contact: '2026-05-04', owner_id: 1, stage_id: 4, expected_revenue: 2800000000 },
  { id: 8, first_name: 'Bùi', last_name: 'Thị Lan', email: 'lan.bt@vng.com.vn', phone: '0911222333', company_id: 8, company_name: 'VNG', job_title: 'Project Manager', status: 'customer', source: 'website', last_contact: '2026-05-07', owner_id: 3, stage_id: 5, expected_revenue: 1800000000 },
];
...
const ACTIVITIES = [
  { 
    ...
    metadata: { 
      ...
      participants: ['Nguyễn Quang Anh', 'Phúc Trọng', 'Minh Khôi'] 
    }, 
  ...
  { 
    ...
    metadata: { 
      duration: '12m 45s', 
      recording_url: 'https://cdn.minth.io/recordings/call_123.mp3', 
      transcription: 'Chào chị Hà, em gọi từ Minth CRM để follow up buổi demo hôm qua...' 
    }, 
  ...
  { 
    ...
    metadata: { 
      email_subject: 'Re: Hạ tầng Cloud VCB - Minth CRM Proposal', 
      status: 'opened', 
      opens: 3, 
      last_open: '2026-05-07T10:15:00Z' 
    }, 
  ...
  { 
    ...
    metadata: { 
      location: 'Lô A, KCN Tân Thuận, Q7', 
      photos: 4 
    }, 
    created_at: '2026-05-03T08:00:00Z' 
  },
  { id: 5, subject: 'Demo Smart Warehouse GHTK', type: 'meeting', status: 'planned', user_name: 'Phúc Trọng', due_date: new Date(Date.now() + 172800000).toISOString(), contact_id: 5, body: 'Thuyết trình giải pháp tự động hóa kho bằng robot.', created_at: new Date(Date.now() - 172800000).toISOString() },
  { id: 6, subject: 'Gửi quà tặng kỷ niệm 10 năm', type: 'note', status: 'done', user_name: 'Phúc Trọng', due_date: '2026-05-02T10:00:00Z', contact_id: 6, body: 'Đã gửi lẵng hoa và thiệp chúc mừng. Khách hàng rất hài lòng.', created_at: '2026-05-02T10:00:00Z' },
  { id: 7, subject: 'Xử lý phản hồi điều khoản bảo trì', type: 'task', status: 'planned', user_name: 'Minh Khôi', due_date: new Date(Date.now() + 259200000).toISOString(), contact_id: 7, body: 'Cập nhật lại SLA bảo trì 24/7 theo yêu cầu từ phòng pháp chế Shopee.', created_at: new Date(Date.now() - 259200000).toISOString() },
];
