        ...
        <div className="card" style={{ padding: '1.25rem' }}>
          ...
          <ResponsiveContainer width="100%" height={240}>
            <ComposedChart data={revenueChart} margin={{ left: -10, right: 5 }}>
              ...
              <Tooltip formatter={(v: any, name: string) => [FMT_VND(Number(v || 0)), name === 'revenue' ? 'Doanh thu' : 'Chi phí']} contentStyle={{ borderRadius: 10, border: 'none', boxShadow: '0 10px 25px rgba(0,0,0,0.1)', fontSize: '0.8125rem' }} />
        ...
        <div className="card" style={{ padding: '1.25rem' }}>
          ...
          <ResponsiveContainer width="100%" height={150}>
            <PieChart>
              ...
              <Tooltip formatter={(v: any, _: string, entry: any) => [`${v} liên hệ`, entry.payload.source]} contentStyle={{ borderRadius: 8, border: 'none', boxShadow: 'var(--shadow-md)', fontSize: '0.8125rem' }} />
            </PieChart>
          </ResponsiveContainer>
